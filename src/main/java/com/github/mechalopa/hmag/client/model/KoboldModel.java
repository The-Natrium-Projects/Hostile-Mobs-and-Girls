...
public class KoboldModel<T extends Mob> extends AbstractAdvancedGirlModel<T>
{
	...
	public static MeshDefinition createMesh(CubeDeformation cd)
	{
		...
		PartDefinition rap2pd = ModClientUtils.addC(rap1pd, cd, "right_arm_part_2", 18, 32, -1.0F, -0.5F, -1.5F, 3.0F, 4.0F, 3.0F, 0.0F, 3.5F, 0.0F, -0.125F);
		PartDefinition lap2pd = ModClientUtils.addC(lap1pd, cd, "left_arm_part_2", 18, 32, -2.0F, -0.5F, -1.5F, 3.0F, 4.0F, 3.0F, 0.0F, 3.5F, 0.0F, true, -0.125F);
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
	{
		...
		this.rightArmPart3.xRot = 0.0F;
		this.leftArmPart3.xRot = 0.0F;
