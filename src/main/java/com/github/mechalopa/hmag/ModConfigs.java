...
public class ModConfigs
{
	...
	public static ModConfigSpec.BooleanValue ENDER_EXECUTOR_REDUCE_DAMAGE;
	public static ModConfigSpec.BooleanValue ENDER_EXECUTOR_BEAM_ATTACK;
	public static ModConfigSpec.BooleanValue LICH_ATTACK_BABY_TURTLES;
	public static ModConfigSpec.BooleanValue LICH_SUMMON_VEX;
	public static ModConfigSpec.BooleanValue OGRE_ATTACK_VILLAGERS;
	public static ModConfigSpec.BooleanValue OGRE_ATTACK_BABY_TURTLES;
	public static ModConfigSpec.BooleanValue OGRE_DESTROY_BLOCKS;
	public static ModConfigSpec.BooleanValue SPIDER_NEST_SUMMON_CAVE_SPIDER;
	public static ModConfigSpec.DoubleValue MELTY_MONSTER_SET_FIRE_CHANCE;
	public static ModConfigSpec.BooleanValue CURSED_DOLL_BURNS_IN_DAYLIGHT;
	public static ModConfigSpec.BooleanValue KASHA_ATTACK_VILLAGERS;
	public static ModConfigSpec.BooleanValue KASHA_ATTACK_BABY_TURTLES;
	public static ModConfigSpec.BooleanValue JACK_FROST_FREEZES_WATER;
	public static ModConfigSpec.BooleanValue JACK_FROST_REGEN;
	public static ModConfigSpec.BooleanValue DULLAHAN_BURNS_IN_DAYLIGHT;
	public static ModConfigSpec.BooleanValue ALRAUNE_ATTACK_VILLAGERS;
	public static ModConfigSpec.BooleanValue ALRAUNE_REGEN;
	public static ModConfigSpec.BooleanValue REDCAP_ATTACK_VILLAGERS;
	public static ModConfigSpec.BooleanValue REDCAP_ATTACK_BABY_TURTLES;
	public static ModConfigSpec.BooleanValue SLIME_GIRL_REGEN;
	public static ModConfigSpec.BooleanValue MAGICAL_SLIME_SPAWNS_ON_SLIME_GIRL_DEATH;
	public static ModConfigSpec.BooleanValue MONOLITH_ATTACK_GOLEMS;
	public static ModConfigSpec.BooleanValue MONOLITH_ATTACK_VILLAGERS;
	public static ModConfigSpec.BooleanValue MONOLITH_ATTACK_ILLAGERS;
	public static ModConfigSpec.DoubleValue MONOLITH_TARGET_DISTANCE;
	public static ModConfigSpec.DoubleValue MONOLITH_BEAM_ATTACK_DISTANCE;
	public static ModConfigSpec.DoubleValue MONOLITH_ROAR_ATTACK_DISTANCE;
	public static ModConfigSpec.DoubleValue MONOLITH_ROAR_ATTACK_RANGE;
	public static ModConfigSpec.BooleanValue CRIMSON_SLAUGHTERER_ATTACK_ANIMALS;
	public static ModConfigSpec.BooleanValue CRIMSON_SLAUGHTERER_ATTACK_VILLAGERS;
	public static ModConfigSpec.BooleanValue DYSSOMNIA_SUMMON_PHANTOM;
	public static ModConfigSpec.BooleanValue SNOW_CANINE_ATTACK_BABY_TURTLES;
	public static ModConfigSpec.BooleanValue SAVAGEFANG_ATTACK_ANIMALS;
	public static ModConfigSpec.BooleanValue SAVAGEFANG_ATTACK_VILLAGERS;
	public static ModConfigSpec.BooleanValue SAVAGEFANG_ATTACK_ILLAGERS;
	public static ModConfigSpec.BooleanValue SAVAGEFANG_ATTACK_DAMAGED_MOBS;
	public static ModConfigSpec.BooleanValue NECROTIC_REAPER_ATTACK_VILLAGERS;
	public static ModConfigSpec.BooleanValue NECROTIC_REAPER_ATTACK_BABY_TURTLES;
	public static ModConfigSpec.BooleanValue DODOMEKI_BURNS_IN_DAYLIGHT;
	public static ModConfigSpec.BooleanValue GLARYAD_REGEN;
	public static ModConfigSpec.BooleanValue JIANGSHI_ATTACK_VILLAGERS;
	public static ModConfigSpec.BooleanValue JIANGSHI_ATTACK_BABY_TURTLES;
	public static ModConfigSpec.BooleanValue GIANT_MUMMY_ATTACK_VILLAGERS;
	public static ModConfigSpec.BooleanValue GIANT_MUMMY_ATTACK_BABY_TURTLES;
	public static ModConfigSpec.BooleanValue GIANT_MUMMY_DESTROY_BLOCKS;

	public static ModConfigSpec.DoubleValue BANSHEE_ANOTHER_VARIANT_SPAWN_CHANCE;
	public static ModConfigSpec.DoubleValue CURSED_DOLL_ANOTHER_VARIANT_SPAWN_CHANCE;
	public static ModConfigSpec.DoubleValue HEADLESS_DULLAHAN_SPAWN_CHANCE;
	public static ModConfigSpec.DoubleValue JIANGSHI_ANOTHER_VARIANT_SPAWN_CHANCE;
	public static ModConfigSpec.DoubleValue PINK_HARPY_SPAWN_CHANCE;

	public static ModConfigSpec.DoubleValue ZOMBIE_GIRL_REPLACE_CHANCE;
	public static ModConfigSpec.DoubleValue HUSK_GIRL_REPLACE_CHANCE;
	public static ModConfigSpec.DoubleValue DROWNED_GIRL_REPLACE_CHANCE;
	public static ModConfigSpec.DoubleValue SKELETON_GIRL_REPLACE_CHANCE;
	public static ModConfigSpec.DoubleValue WITHER_SKELETON_GIRL_REPLACE_CHANCE;
	public static ModConfigSpec.DoubleValue STRAY_GIRL_REPLACE_CHANCE;
	public static ModConfigSpec.DoubleValue CREEPER_GIRL_REPLACE_CHANCE;
	public static ModConfigSpec.DoubleValue ENDER_EXECUTOR_REPLACE_CHANCE;

	public static ModConfigSpec.DoubleValue GHASTLY_SEEKER_SPAWN_CHANCE;
	public static ModConfigSpec.DoubleValue CRIMSON_SLAUGHTERER_SPAWN_CHANCE;
	public static ModConfigSpec.DoubleValue SAVAGEFANG_SPAWN_CHANCE;

	public static ModConfigSpec.IntValue SURFACE_MOB_SPAWN_MIN_HEIGHT;
	public static ModConfigSpec.IntValue KOBOLD_SPAWN_MAX_HEIGHT;
	public static ModConfigSpec.IntValue LICH_SPAWN_MAX_HEIGHT;
	public static ModConfigSpec.IntValue OGRE_SPAWN_MAX_HEIGHT;
	public static ModConfigSpec.IntValue SPIDER_NEST_SPAWN_MAX_HEIGHT;
	public static ModConfigSpec.IntValue NECROTIC_REAPER_SPAWN_MAX_HEIGHT;

	public static ModConfigSpec.IntValue INSOMNIA_FRUIT_COOLDOWN_LEVEL_0;
	public static ModConfigSpec.IntValue INSOMNIA_FRUIT_COOLDOWN_LEVEL_1;
	public static ModConfigSpec.IntValue INSOMNIA_FRUIT_COOLDOWN_LEVEL_2;
	public static ModConfigSpec.IntValue INSOMNIA_FRUIT_COOLDOWN_LEVEL_3;
	public static ModConfigSpec.IntValue INSOMNIA_FRUIT_COOLDOWN_LEVEL_4;
	public static ModConfigSpec.IntValue INSOMNIA_FRUIT_COOLDOWN_LEVEL_5;

	public static ModConfigSpec.IntValue HEALTH_BOOST_MAX_LEVEL;
	public static ModConfigSpec.BooleanValue HEALTH_BOOST_IS_TREASURE;
	public static ModConfigSpec.BooleanValue HEALTH_BOOST_IS_TRADEABLE;
	public static ModConfigSpec.BooleanValue HEALTH_BOOST_IS_DISCOVERABLE;
	public static ModConfigSpec.IntValue WATER_ASPECT_MAX_LEVEL;
	public static ModConfigSpec.BooleanValue WATER_ASPECT_IS_TREASURE;
	public static ModConfigSpec.BooleanValue WATER_ASPECT_IS_TRADEABLE;
	public static ModConfigSpec.BooleanValue WATER_ASPECT_IS_DISCOVERABLE;
	public static ModConfigSpec.IntValue ANTI_AIR_MAX_LEVEL;
	public static ModConfigSpec.BooleanValue ANTI_AIR_IS_TREASURE;
	public static ModConfigSpec.BooleanValue ANTI_AIR_IS_TRADEABLE;
	public static ModConfigSpec.BooleanValue ANTI_AIR_IS_DISCOVERABLE;

	public static ModConfigSpec.BooleanValue KOBOLD_POTION_BREWING_RECIPES;
	public static ModConfigSpec.BooleanValue HEALING_III_POTION_BREWING_RECIPES;
	public static ModConfigSpec.BooleanValue HARMING_III_POTION_BREWING_RECIPES;
	public static ModConfigSpec.BooleanValue REGENERATION_III_POTION_BREWING_RECIPES;
	public static ModConfigSpec.BooleanValue OGRE_POTION_BREWING_RECIPES;
	public static ModConfigSpec.BooleanValue VORACITY_POTION_BREWING_RECIPES;
	public static ModConfigSpec.BooleanValue ENDER_RAGE_POTION_BREWING_RECIPES;
	public static ModConfigSpec.BooleanValue COMBUSTION_POTION_BREWING_RECIPES;
	public static ModConfigSpec.BooleanValue SLOWNESS_POTION_BREWING_RECIPES;
	public static ModConfigSpec.BooleanValue INVISIBILITY_POTION_BREWING_RECIPES;
	public static ModConfigSpec.BooleanValue BLASTING_BOTTLE_BREWING_RECIPE;
	public static ModConfigSpec.BooleanValue LIGHTNING_BOTTLE_BREWING_RECIPE;

	public static ModConfigSpec.BooleanValue ADDITIONAL_VILLAGER_TRADES;
