...
import net.neoforged.common.ForgeSpawnEggItem;
...
public class ModItems
{
	...
	public static final RegistryObject<Item> GOLDEN_TROPICAL_FISH = REGISTRY.register("golden_tropical_fish", () -> new Item(new Item.Properties().food((new FoodProperties.Builder()).nutrition(5).saturationMod(1.3F).effect(() -> new MobEffectInstance(MobEffects.ABSORPTION, 60 * 20, 1), 1.0F).effect(() -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 15 * 20, 0), 1.0F).effect(() -> new MobEffectInstance(MobEffects.WATER_BREATHING, 15 * 20, 0), 1.0F).alwaysEat().build()).rarity(Rarity.RARE)));
	...
	public static final RegistryObject<Item> ANCIENT_HELMET = REGISTRY.register("ancient_helmet", () -> new ArmorItem(ModArmorMaterial.ANCIENT, ArmorItem.Type.HELMET, (new Item.Properties()).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> ANCIENT_CHESTPLATE = REGISTRY.register("ancient_chestplate", () -> new ArmorItem(ModArmorMaterial.ANCIENT, ArmorItem.Type.CHESTPLATE, (new Item.Properties()).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> ANCIENT_LEGGINGS = REGISTRY.register("ancient_leggings", () -> new ArmorItem(ModArmorMaterial.ANCIENT, ArmorItem.Type.LEGGINGS, (new Item.Properties()).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> ANCIENT_BOOTS = REGISTRY.register("ancient_boots", () -> new ArmorItem(ModArmorMaterial.ANCIENT, ArmorItem.Type.BOOTS, (new Item.Properties()).rarity(Rarity.UNCOMMON)));
	...
	public static final RegistryObject<Item> NECROTIC_CHAINMAIL_HELMET = REGISTRY.register("necrotic_chainmail_helmet", () -> new ArmorItem(ModArmorMaterial.NECROTIC_CHAIN, ArmorItem.Type.HELMET, (new Item.Properties()).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> NECROTIC_CHAINMAIL_CHESTPLATE = REGISTRY.register("necrotic_chainmail_chestplate", () -> new ArmorItem(ModArmorMaterial.NECROTIC_CHAIN, ArmorItem.Type.CHESTPLATE, (new Item.Properties()).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> NECROTIC_CHAINMAIL_LEGGINGS = REGISTRY.register("necrotic_chainmail_leggings", () -> new ArmorItem(ModArmorMaterial.NECROTIC_CHAIN, ArmorItem.Type.LEGGINGS, (new Item.Properties()).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> NECROTIC_CHAINMAIL_BOOTS = REGISTRY.register("necrotic_chainmail_boots", () -> new ArmorItem(ModArmorMaterial.NECROTIC_CHAIN, ArmorItem.Type.BOOTS, (new Item.Properties()).rarity(Rarity.UNCOMMON)));
	...
	public static final RegistryObject<Item> FORTUNE_CRYSTAL = REGISTRY.register("fortune_crystal", () -> new ModItem(new Item.Properties().rarity(Rarity.UNCOMMON), new ModItem.Properties().foil()));
	public static final RegistryObject<Item> FORTUNE_CRYSTAL_PLUS = REGISTRY.register("fortune_crystal_plus", () -> new ModItem(new Item.Properties().rarity(Rarity.RARE), new ModItem.Properties().foil()));
