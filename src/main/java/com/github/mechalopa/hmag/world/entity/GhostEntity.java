...
public class GhostEntity extends AbstractFlyingMonsterEntity implements VariantHolder<GhostEntity.Variant>
{
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor levelAccessor, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnData, @Nullable CompoundTag dataTag)
	{
		...
		this.setVariant(GhostEntity.Variant.getSpawnVariant(randomsource));
	...
	@Override
	public GhostEntity.Variant getVariant()
	{
		return GhostEntity.Variant.byId(this.entityData.get(DATA_VARIANT_ID));
	}

	@Override
	public void setVariant(GhostEntity.Variant variant)
	{
	...
	public void readAdditionalSaveData(CompoundTag compound)
	{
		...
		this.setVariant(GhostEntity.Variant.byId(compound.getInt("Variant")));
	}
	...
	public static enum Variant implements StringRepresentable
	{
		...
		private static final IntFunction<GhostEntity.Variant> BY_ID = ByIdMap.continuous(GhostEntity.Variant::getId, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
		public static final Codec<GhostEntity.Variant> CODEC = StringRepresentable.fromEnum(GhostEntity.Variant::values);
		...
		public static GhostEntity.Variant byId(int id)
		{
			return BY_ID.apply(id);
		}

		public static GhostEntity.Variant getSpawnVariant(RandomSource random)
		{
			GhostEntity.Variant[] variants = Arrays.stream(values()).toArray(p -> {
				return new GhostEntity.Variant[p];
			});
