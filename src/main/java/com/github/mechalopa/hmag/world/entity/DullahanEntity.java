...
public class DullahanEntity extends Monster implements VariantHolder<DullahanEntity.Variant>
{
	...
	@Override
	public void setVariant(DullahanEntity.Variant variant)
	{
	...
	public static enum Variant implements StringRepresentable
	{
		...
		private static final IntFunction<DullahanEntity.Variant> BY_ID = ByIdMap.continuous(DullahanEntity.Variant::getId, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
		public static final Codec<DullahanEntity.Variant> CODEC = StringRepresentable.fromEnum(DullahanEntity.Variant::values);
		...
		public static DullahanEntity.Variant byId(int id)
		{
