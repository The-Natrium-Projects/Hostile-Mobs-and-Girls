...
public class SavagefangEntity extends Monster
{
	...
	{
		return levelReader.getFluidState(pos).is(FluidTags.WATER) ? 10.0F + levelReader.getPathfindingCostFromLightLevels(pos) - 0.5F : super.getWalkTargetValue(pos, levelReader);
	}
