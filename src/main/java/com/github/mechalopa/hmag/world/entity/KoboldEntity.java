...
public class KoboldEntity extends Monster
{
	...
	public static boolean checkKoboldSpawnRules(EntityType<? extends KoboldEntity> type, ServerLevelAccessor levelAccessor, MobSpawnType spawnType, BlockPos pos, RandomSource random)
	{
