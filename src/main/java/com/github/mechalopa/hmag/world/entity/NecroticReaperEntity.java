...
public class NecroticReaperEntity extends Monster
{
	...
	public static boolean checkNecroticReaperSpawnRules(EntityType<? extends NecroticReaperEntity> type, ServerLevelAccessor levelAccessor, MobSpawnType spawnType, BlockPos pos, RandomSource random)
	{
